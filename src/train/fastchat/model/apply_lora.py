...
Hadi Usage
python3 -m fastchat.model.apply_lora --base Universal-NER/UniNER-7B-all --target saved_models/qlora-UniNER-certain-hf --lora saved_models/qlora-UniNER-certain/checkpoint-37200
